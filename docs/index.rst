...
Everything is controlled by Managers, which are not communicated with each other, and have one single responsibility.  
...
It's the Manager responsibility, although we can configure it.
